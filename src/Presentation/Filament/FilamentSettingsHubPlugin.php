...
namespace Juniyasyos\FilamentSettingsHub\Presentation\Filament;

use Filament\Contracts\Plugin;
use Filament\Panel;
use Filament\Support\Concerns\EvaluatesClosures;
use Juniyasyos\FilamentSettingsHub\Facades\FilamentSettingsHub;
use Juniyasyos\FilamentSettingsHub\Presentation\Filament\Pages\AuthenticationSettingsPage;
use Juniyasyos\FilamentSettingsHub\Presentation\Filament\Pages\LocationSettingsPage;
use Juniyasyos\FilamentSettingsHub\Presentation\Filament\Pages\SettingsHubPage;
use Juniyasyos\FilamentSettingsHub\Presentation\Filament\Pages\SiteSettingsPage;
use Juniyasyos\FilamentSettingsHub\Presentation\Filament\Pages\SocialMenuSettingsPage;
...
class FilamentSettingsHubPlugin implements Plugin
{
    ...
    protected static array $settings = [
        ...
        'social' => [
            'page' => SocialMenuSettingsPage::class,
            'order' => 2,
        ...
        'location' => [
            'page' => LocationSettingsPage::class,
            'order' => 3,
            'icon' => 'heroicon-o-map',
        ...
        'authentication' => [
            'page' => AuthenticationSettingsPage::class,
            'order' => 4,
    ...
    public function allowAuthenticationSettings(bool|\Closure $allow = true): static
    {
    ...
    public function isAuthenticationSettingAllowed(): bool
    {
